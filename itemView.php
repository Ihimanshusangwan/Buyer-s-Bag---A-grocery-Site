...
imgs;
            ...
            <div class="item-details-preview">
                ...
                <?php
                $qty = 0;
                if (isset($_SESSION['bag'][$item_data['id']]['qty'])) {
                    $qty = $_SESSION['bag'][$item_data['id']]['qty'];
                }
                ?>
    ...
    <div class="similar-item-box">
        ...
        while ($a <= 6 && $similar_item_data = mysqli_fetch_array($similar_item_query_result)) {
            if ($similar_item_data['id'] != $item_data['id']) {
                $qty = 0;
                if (isset($_SESSION['bag'][$similar_item_data['id']]['qty'])) {
                    $qty = $_SESSION['bag'][$similar_item_data['id']]['qty'];
                }
                echo <<<box
